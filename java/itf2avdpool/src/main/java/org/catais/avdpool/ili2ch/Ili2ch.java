package org.catais.avdpool.ili2ch;
...
public class Ili2ch {
	...
	private String iliInput = null;
	private String iliOutput = null;
	private String itfInput = null;
	private String itfOutput = null;

	public Ili2ch(String itfInput, String itfOutput) {
		this.itfInput = itfInput;
		this.itfOutput = itfOutput;
		
		this.iliInput = getModelNameFromItf(itfInput);
		this.iliOutput = "DM01AVCH24D";
	}

	public void convert() throws Ili2cException {
