...
<qgis version="2.7.0-Master" minimumScale="-4.65661e-10" maximumScale="2000" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{7e55e867-7796-4ea7-96a8-9b046a86a7bd}">
      <rule filter="typ = 'Mast_Antenne'" key="{86a42989-7977-4ada-b2d8-214386e3018f}" symbol="0" label="Mast_Antenne"/>
      <rule filter="typ = 'wichtiger_Einzelbaum'" key="{3ee511ec-42a1-4a43-88eb-fd190c19499f}" symbol="1" label="wichtiger_Einzelbaum"/>
    </rules>
    <symbols>
